				...
				<div class="container">
					<div class="row">
						<div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
							<form method="post" action="/easypgadmin/admin/loggingIn"
								modelAttribute="log">
								<div class="card card-login card-hidden">
									...
									%>
									<div style="color: red; margin-left: 23%"><%=request.getParameter("errorMsg")%></div>
									<%
									}
									%>
									...
									<div class="footer text-center">
										<button type="submit"
											class="btn btn-rose btn-simple btn-wd btn-lg">Let's
											go</button>
									</div>
